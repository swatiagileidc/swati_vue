<template>
  <div>
    ...
    <tabs :tabs="tabs" :currentTab="currentTab" :wrapper-class="'body-tabs shadow-tabs'" :tab-class="'tab-item'" :tab-active-class="'tab-item-active'" :line-class="'tab-item-line'" @onClick="handleClick" />
    <div class="content">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="main-card mb-3 card">
                <div class="card-header">Outstanding Assignments</div>
                      ...
                      <table class="align-middle mb-0 table table-borderless table-striped table-hover table-fixed">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><button @click="showOutsandingAssignments('overview')" type="button" class="btn mr-2 mb-2 btn-pill btn-hover-shine btn-transition btn-danger">Alert</button></td>
                          </tr>
                          <tr>
              ...
              <!--New ASSIGNMENTS-->
              <div class="main-card mb-3 card">
                <div class="card-header">NEW ASSIGNMENTS</div>
                      ...
                      <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        <tbody>
                          <tr>
                            ...
                            <td class="text-center"><button type="button" class="btn mr-2 mb-2 btn-pill btn-hover-shine btn-transition btn-warning">Scheduled</button></td>
                          </tr>
                          <tr>
                            <td class="text-muted"><div class="b-l-warning">Science (3A)</div></td>
                            <td>
                            ...
                            <td class="text-center"><button type="button" class="btn btn-sm mr-2 mb-2 btn-pill btn-hover-shine btn-transition btn-primary">Create</button></td>
                          </tr>
                          <tr>
                            <td class="text-muted"><div class="b-l-primary">Maths (5B)</div></td>
                            <td>
                            ...
                            <td class="text-center"><button type="button" class="btn mr-2 mb-2 btn-pill btn-hover-shine btn-transition btn-success">Send</button></td>
                          </tr>
                          <tr>
                            <td class="text-muted"><div class="b-l-warning">Science (3A)</div></td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td><div class="badge badge-warning">2 Days</div></td>
                            <td class="text-center"><button type="button" class="btn mr-2 mb-2 btn-pill btn-hover-shine btn-transition btn-primary">Create</button></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                      ...
                      <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><button type="button" class="btn mr-2 mb-2 btn-pill btn-hover-shine btn-transition btn-success">Mark</button></td>
                          </tr>
                          <tr>
                            <td class="text-muted"><div class="b-l-primary">Maths (5B)</div></td>
                            <td>
            ...
            <div class="col-lg-6">
              <div class="main-card mb-3 card">
                <div class="card-header">Assignemnt Calendar 123</div>
                <cal3></cal3>
              </div>
            </div>
            <!--ASSIGNEMNT CALENDAR-->
...
export default {
  ...
  data: () => ({
    heading: "Assignment",
    subheading: "Manage Homeworks/Assignment related activities.",
