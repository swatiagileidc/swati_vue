  ...
  <div>
    <div class="app-page-title">
        ...
        <div class="page-title-heading">
          ...
          <v-btn to="/teacher/online-classes" type="button" class="text-white btn-shadow d-inline-flex align-items-center btn btn-success">
...
export default {
  ...
  mounted () {
      ...
      axios.get('/api/teacher/start-meeting/'+this.link)
      .then(response => {  
