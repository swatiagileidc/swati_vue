     ...
     <div class="app-page-title">
      <div class="page-title-wrapper">
        ...
        <div class="page-title-actions" >
          <v-btn to="/components/onlineclasses" type="button" class="text-white btn-shadow d-inline-flex align-items-center btn btn-success">
          ...
          <b-row>
            <b-col md="12">
                 <b-card title="Meeting Details" class="main-card mb-3">
                  <b-form id="signup-form" @submit.prevent="UpdateFormData">
                    <b-form-group id="subject" label="Subject" label-for="subject">
                      <b-form-input id="subject" type="text" v-model="form.subject"
                        :state="!$v.form.subject.$invalid" aria-describedby="input2LiveFeedback" placeholder="Enter Subject"/>
                    ...
                    <!-- <b-form-group id="duration" label="Duration(In Minutes)" label-for="duration">
                      <b-form-input id="duration" style="width:150px;" type="number" v-model="form.duration"
...
export default {
  ...
  data: () => ({
    ...
    subheading:
      "Here you can update meetings Details.",
...
mounted () {
  this.user = JSON.parse(localStorage.getItem('user'));
    this.getClassDetails();
      ...
      axios.get(process.env.VUE_APP_API_URL_MEETING +'teacher/meeting/'+this.id)
      .then(response => {  
          this.form.meeting_id = response.data.meeting_id;
          this.selectedClass = response.data.class;
          this.form.time_to = response.data.time_to;
          this.form.subject = response.data.subject;
          this.form.time_from = response.data.time_from;
          this.form.meeting_name = response.data.meeting_name;
          this.form.attendee_pass = response.data.attendee_pass;
          this.form.moderator_pass = response.data.moderator_pass;
          this.form.welcome=  response.data.welcome;
          this.form.max_participants=  response.data.max_participants;
          this.form.duration=  response.data.duration;
          this.form.moderator_only_message=  response.data.moderator_only_message;
          this.form.auto_start_recording=  response.data.auto_start_recording;
          this.form.allow_start_stop_recording =  response.data.allow_start_stop_recording;
          this.form.webcams_only_for_moderator=  response.data.webcams_only_for_moderator;
          this.form.mute_on_start =  response.data.mute_on_start;
          this.form.class_date = response.data.class_date;
      }).catch(error => {
        console.log(error);
      })
  },
  ...
  methods: {
      ...
      //var meeting_id = this.form.meeting_id;
        axios.post(process.env.VUE_APP_API_URL_MEETING +'teacher/update-meeting-details/'+this.id, {
          ...
          attendee_pass :this.form.attendee_pass,
          moderator_pass :this.form.moderator_pass,
          ...
          webcams_only_for_moderator: this.form.webcams_only_for_moderator,
