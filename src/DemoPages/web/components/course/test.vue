                    ...
                    <template v-slot:item="props" class="mb-5">
                      ...
                      >
                        <td v-if="test_list.subject_id == item.id">
                          ...
                          <td v-if="test_list.subject_id == item.id && test_list.is_scheduled == 1">
                          {{ test_list.schedule_date_time|formatDate }} {{ test_list.scheduled_time }}
                        </td>
                          <td v-if="test_list.subject_id == item.id && test_list.is_scheduled == 0">
                          {{ test_list.due_date|formatDate }}
                        </td>
                        <td v-if="test_list.subject_id == item.id">
                          <span v-if="test_list.total_marks_obtained!=null">{{ test_list.total_marks_obtained }}</span>
                          <span class="text-danger" v-if="test_list.total_marks_obtained==null ">{{$t('absent')}}</span>
                        </td>
                        <td v-if="test_list.subject_id == item.id">
                          {{ test_list.total_marks }}
                        </td>
                        <td v-if="test_list.subject_id == item.id">
                          {{
                            (
                              (test_list.total_marks_obtained / test_list.total_marks) *
                              100
                            ).toFixed(1) + "%"
                          }}
                        </td>
